...
sudo grep -o '^0,.*' data/IDN60901.94768.axf >> data/hist_IDN60901.94768.csv
# download latest observations 
sudo curl -o data/IDN60901.94768.axf http://www.bom.gov.au/fwo/IDN60901/IDN60901.94768.axf
sudo curl -o data/IDN60901.94768.json http://www.bom.gov.au/fwo/IDN60901/IDN60901.94768.json
