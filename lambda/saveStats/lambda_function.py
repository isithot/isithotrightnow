...
def lambda_handler(event, context):
    ...
    for this_station in station_set:
        ...
        # Append today's observation to historical data
        hist_obs.loc[len(hist_obs)] = [current_date.year, current_date.month, current_date.day, tmax_now, tmin_now, tavg_now]

        print(f"Appending today to hist obs: {this_station['label']}")
